...
\vspace{0.3em}
\textbf{EEGPT failure:} cross-attention pools 19\,ch $\to$ 1 token; channel-drop creates incompatible views.
...
\begin{frame}{Latent Space: BIOT vs EB-JEPA (LDA Comparison)}
