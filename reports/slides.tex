% Final presentation — EB-JEPA for Clinical EEG
% Style mirrors hackathon_guide/two_rooms_example_slides.pdf (organisers' template).
% Content mirrors reports/hackathon_report.{tex,pdf} (our research report).
% Figures reused from reports/figures/ (previously assembled in reports/beamer.tex).
...
% ─── colours that match the organisers' template ────────────────────────────
...
% ─── callout boxes that mirror the template's "◇ COULD HELP" / "★ EXPLORATION"
%    we re-purpose them as ◇ CAVEAT (red) and ★ FINDING (gold)
...
% ============================================================================
% TITLE SLIDE — full-bleed deep-blue gradient, mirroring the template
% ============================================================================
{\setbeamertemplate{footline}{}
\begin{frame}[plain]
...
\tikz[baseline=(b.base)]{\node[fill=tplred,text=white,rounded corners=2pt,
  inner xsep=5pt,inner ysep=2pt,font=\small\sffamily\bfseries] (b) {$\Diamond$ caveat = an honest limit};}\,\,%
...
\textbf{What it is.}\\
A complete, honest walk-through of our EB-JEPA submission on \textbf{TUAB} (binary
...
\end{findingbox}
\vspace{0.5em}
\begin{caveatbox}\caveattag One honest limit\\[0.2em]
...
% ============================================================================
% EVALUATION · 1/3 — EB-JEPA reference table on TUAB
% ============================================================================
...
% ============================================================================
% EVALUATION · 2/3 — Robustness / HP / ablation
% ============================================================================
...
% ============================================================================
% EVALUATION · 3/3 — combined vs literature
% ============================================================================
\sectionheader{EVALUATION \,\textperiodcentered\, 3/3 \,\,\,\,Combined --- baselines vs.\ EB-JEPA}
\begin{frame}{Honest position vs.\ literature (per-recording-via-window)}
\begin{columns}[T,onlytextwidth]
\column{0.55\textwidth}
\centering\small
\begin{tabular}{@{}lccl@{}}
...
{\color{white!85}\sffamily\large \emph{EB-JEPA for Clinical EEG \,---\, an honest first run}}\\[1.4em]
