...
deterministic. The honest consequence is sobering: \textbf{the $<$3\,pp per-recording gaps that separate
...
a competitive, honest, and cheap result, whose main limit is the near-saturation of TUAB itself.
...
baselines. The honest, reproducible findings are (a) EEG SSL prefers weak view-invariance, (b) the
