# 🎯 REFERENCE TABLE — Ground truth for the EEG SOTA comparison

> **This is THE authoritative table for the state-of-the-art comparison on TUAB.**
> Every other doc (`SOTA_TABLE.md`, `RESULTS_COMPILED.md`, `LITERATURE_VS_OURS.md`,
> `PER_RECORDING_TABLE.md`, the LaTeX report, slides, …) **must defer to this file**.
> If a number in another doc disagrees with this one, this one is correct.

For every literature baseline whose number appears in our SOTA comparison, this file
...
**LaBraM Table 1** (`papers/LaBraM_2405.18765.pdf`). EEGNet / ShallowConvNet params
measured locally from `braindecode.models.EEGNetv4` and `braindecode.models.ShallowFBCSPNet`
constructed with `(n_chans=19, n_outputs=2, n_times=2000)`.
